...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ['Luís Bevilacqua', 'Rodrigo Masaru', 'Fernanda Thomazinho', 'Celso Crivelaro', 'Vinicius Oyama', 'Roberto Santelices']
  spec.email         = ['robertosante@gmail.com']

  spec.summary       = 'A gem to help with changelog management'
  spec.description   = 'A simple to use gem made to help managing changelogs avoiding conflicts and missplaced changes, updated with newest dependencies'
  spec.license       = 'MIT'
  spec.homepage      = 'https://github.com/robertosante/codelog'
